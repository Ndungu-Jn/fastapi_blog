...
POSTS = [
    ...
    },
    {
        ...
        "content": "I don't read a lot of fiction. The last fiction book I read was 'The Martian' by Andy Weir, which I really enjoyed. But most of my reading is non-fiction. Some of my favorites are 'Meditations' by Marcus Aurelius, 'Conscious' by Annaka Harris, 'How to Die' by Seneca, and 'The Last Lecture' by Randy Pausch.",
    },
    {
    ...
    },
    {
        ...
        "content": "I love Settlers of Catan. It's a classic for a reason. I'm actually going to make a sword in my woodshop soon that will be my friend group's trophy for the annual Catan champion that we're going to call 'The Katana of Catan'.",
    },
    {
    ...
    },
    {
        ...
        "content": "Woodworking, hands down. I love making things with wood, but I wish I had more time for it. There's something special about making something with your own hands, with materials that are local.",
    },
    {
    ...
    },
    {
        ...
        "content": "Add a /health endpoint to your API. Load balancers and orchestrators need to know if your service is alive. Return 200 if healthy, details if not.",
    },
    {
        "title": "Hmm... What Else?",
    ...
    {
        "title": "Movie Quotes!",
        "content": "'You wanna know how I did it? This is how I did it, Anton. I never saved anything for the swim back.' - 'Gattaca'. One of my favorite movies of all time.",
    },
]
...
POST_44 = {
    ...
    "content": "If you've paginated all the way to this post, the 44th one... you get to learn this fun fact: that my high school football number was #44. Other notable absolute legends who wore number #44 include: Jerry West (NBA), Hank Aaron (MLB), and Floyd Little (NFL).",
}
...
async def clear_existing_data() -> None:
    ...
    Posts are deleted first because they depend on users.
    """

    async with AsyncSessionLocal() as db:
        print("\nClearing existing data...")

        # Delete posts first because they reference users
...
async def update_post_dates() -> None:
    """
    Give each post a different date.

    This is useful for testing pagination and ordering.
    """
    ...
    async with AsyncSessionLocal() as db:
        ...
        # First post is the oldest.
        await db.execute(
            update(models.Post)
            .where(models.Post.id == posts[0].id)
            .values(
                date_posted=now - timedelta(days=90)
            )
        )

        # Give the remaining posts different dates.
...
async def populate() -> None:
    ...
    # Create an HTTP client that talks directly to
    ...
    async with httpx.AsyncClient(
        ...
        #
        # This is done intentionally because we will later
        # make this the oldest post.
        response = await client.post(
            "/api/posts",
            json={
                "title": POST_44["title"],
        ...
        # Create the remaining posts.
        #
        # reversed() keeps the original tutorial ordering
        # where the final posts become older/newer after
        # we update their dates.
    ...
    print(f"Posts: {len(POSTS) + 1}")
    print("Images: Not used (S3 disabled)")
